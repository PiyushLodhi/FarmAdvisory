...
class CoreferenceResolver:
    ...
    def resolve_coreferences(self,corefs,doc,ner,verbose):
        ...
        for index,coreferences in enumerate(corefs.values()):    # corefs : {[{}]} => coreferences : [{}]
            ...
            print('coreferences: '+str(type(coreferences)))
            print('check1')
            if(len(coreferences)==3):
                print(coreferences)
            print('check2')
            ...
            for reference in coreferences:      # reference : {}
                ...
                print('replace_with: '+str(replace_with))
        ...
        for index,sent in enumerate(sentences):
            ...
            for item in replacement_list[::-1]:                     # item : ({},int)
                ...
                words = nltk.word_tokenize(replaced_sent)
                replaced_sent = ""
    ...
    for file in file_list:
        ...
        for i in range(1,len(sys.argv)):
            if(sys.argv[i] == "nltk"):
                ...
                #spacy_ner = SpacyNER() #added by me
        ...
        print('test_value: '+str(file.split('/')[-1]))
